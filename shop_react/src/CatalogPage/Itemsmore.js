...
export function Item1() {
    ...
    <strong><h2>Price: 5299 UAH</h2></strong>
    </div>
  ...
  export function Item2() {
    return <div>
        ...
        <p className='txt'>Standard satin shirt with Italian collar, short sleeves and side slits at the bottom. Fastens with buttons on the front.</p>
        <p className='txt'>Countable field</p>
        <input></input>
        <p className='txt2'>Selectable Field</p>
    ...
    <button id="btn3">Go back</button>
    <button id="btn4">Add to cart</button>
    <strong><h2>Price: 1499 UAH</h2></strong>
    </div>
  ...
  export function Item3() {
    return <div>
        ...
        <p className='txt'>Lightweight basic T-shirt with a round collar and short sleeves. Made of cotton.⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀</p>
        <p className='txt'>Countable field</p>
        <input></input>
        <p className='txt2'>Selectable Field</p>
    ...
    <button id="btn3">Go back</button>
    <button id="btn4">Add to cart</button>
    <strong><h2>Price: 499 UAH</h2></strong>
    </div>
  ...
  export function Item4() {
    return <div>
        ...
        <p className='txt'>T-shirt with a round collar in the hem and long sleeves. Consignment note front pocket.⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀</p>
        <p className='txt'>Countable field</p>
        <input></input>
        <p className='txt2'>Selectable Field</p>
    ...
    <button id="btn3">Go back</button>
    <button id="btn4">Add to cart</button>
    <strong><h2>Price: 299 UAH</h2></strong>
    </div>
